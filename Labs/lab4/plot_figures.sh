...
python3.4 plot_queue.py --maxy 100 --miny 0 -f ${exp}_sw0-qlen.txt -o ${exp}_queue.png >/dev/null
python3.4 plot_tcpprobe.py -f ${exp}_tcpprobe.txt -o ${exp}_tcp_cwnd_iperf.png -p 5001 >/dev/null
python3.4 plot_tcpprobe.py -f ${exp}_tcpprobe.txt -o ${exp}_tcp_cwnd_wget.png -p 80 --sport >/dev/null
...
python3.4 -m http.server 8888 --bind 127.0.0.1
